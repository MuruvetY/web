...
<?php
 ...
 $telefon="+905393915699";
 $telefon= str_split($telefon,3);
 print_r($telefon);
  
 echo "<br> Telefon Numarası : ". implode(" ",$telefon);
...
echo "Sayılar Dizisinin İçerisindeki 1. Dizinin 1 İndisli Elemanı: " . $sayilar["Integer"][1] ;

echo "<br>Sayılar Dizisinin İçerisindeki 1. Dizinin 2 İndisli Elemanı: " . $sayilar["Double"][2] ;
